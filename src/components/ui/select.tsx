...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      // --- PREMIUM LIMITLESS STYLE ---
      "flex h-11 w-full items-center justify-between rounded-xl px-4 py-2",
      "bg-black/20 backdrop-blur-xl border border-white/10",
      "text-white/80 placeholder:text-white/40",
      "transition-all duration-300",
      "hover:border-white/20 hover:bg-black/30 hover:text-white",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ref={ref}
    className={cn(
      "flex cursor-default items-center justify-center py-1 text-white/60",
      className
    )}
    {...props}
  >
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "py-2 pl-8 pr-2 text-sm text-white/70",
      "hover:bg-white/10 hover:text-white",
      "focus:bg-white/20 focus:text-white outline-none",

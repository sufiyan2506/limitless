...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ...
    className={cn(
      // Base
      "peer relative h-4 w-4 shrink-0 rounded-[6px] border transition-all",
      "border-white/15 bg-black/40 backdrop-blur-sm",
      "data-[state=checked]:border-primary data-[state=checked]:bg-primary/20",

      // Glow when checked
      "data-[state=checked]:shadow-[0_0_8px_rgba(0,240,255,0.45)]",
  ...
  >
    <CheckboxPrimitive.Indicator
      className={cn(
        ...
        "transition-transform duration-200 data-[state=checked]:scale-100 scale-0"
      )}
    >

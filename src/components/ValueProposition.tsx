            ...
            >
              ...
              <div className="rounded-3xl bg-black/90 backdrop-blur-xl p-8 h-full flex flex-col">
                ...
                <div className="relative mb-7">
                  <div className="absolute inset-0 blur-xl opacity-60 bg-gradient-to-br from-white to-transparent"></div>
                  <img
                    src={card.icon}
                    className="relative w-14 h-14 object-contain drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]"
                  />
                </div>
